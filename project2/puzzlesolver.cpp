...
int main(int argc, char* argv[]) {
    ...
    //part3(udp_sock, oracleaddr, evil_bit_secret_port, secret_phrase, hidden_port, ports[1]);
    part3(udp_sock, oracleaddr, "4099", "Hey you, you’re finally awake. You were trying to cross the border right? Walked right into that Imperial ambush same as us and that thief over there.", "4033", 4042);
}
